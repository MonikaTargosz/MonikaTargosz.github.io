...
<body ondragstart="return false" ondrag="return false" onbeforeprint="document.body.style.visibility = 'hidden'; alert('Wydruk jest niedostępny!')" onafterprint="document.body.style.visibility = 'visible'">
        ...
        <div class="cm1">
         ...
         <div class="cm3">
             ...
             <br><a href="#Create your">The first steps in Android Studio</a><br/>
               ...
               <a href="#Sources">Source code</a><br/>
         ...
         <div class="cm16"> 
            <a name="Debugging USB project of Android Studio"></a>
             <br><br/><p style="text-indent: 10%; font-size: 13pt;"><b>Debugging USB project of Android Studio</b></p>
         ...
         <div class="cm21"> 
            <a name="Sources"></a>
             <br><br/><p style="text-indent: 10%; font-size: 13pt;"><b>Sources</b></p>
             <br><br/><p style="text-indent: 10%;">This YouTube's playlist of Android Studio is very helpful for the beginners: <a href="https://www.youtube.com/playlist?list=PLshdtb5UWjSp0879mLeCsDQN6L73XBZTk">Playlista Android Tutorial 2015</a><br><br/></p>
          </div>
